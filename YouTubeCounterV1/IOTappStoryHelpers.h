...
void loopWiFiManager() {
  ...
  WiFiManagerParameter p_YouTubeID("YouTubeID", "YouTubeID", config.YouTubeID, STRUCT_CHAR_ARRAY_SIZE);
  WiFiManagerParameter p_googleKey("googleKey", "googleKey", config.googleKey, STRUCT_CHAR_ARRAY_SIZE);
  ...
  */
  ...
  //add all parameters here
  wifiManager.addParameter(&p_YouTubeID);
  wifiManager.addParameter(&p_googleKey);
  ...
  //additional fields
  strcpy(config.YouTubeID, p_YouTubeID.getValue());
  strcpy(config.googleKey, p_googleKey.getValue());
